...
public class TestCode {
    ...
    public static void test() {
         ...
         */
        //http://202.189.11.84:26905/api/logs?key=0TELTUnbQ8N7&page=1&limit=50&searchkey=EOS_0002384ee44a4bbd95fb792b3161d4da
        //http://127.0.0.1:26905/logs?key=0TELTUnbQ8N7&page=1&limit=20&searchkey=EOS_0002384ee44a4bbd95fb792b3161d4da
        $7DTD._Log.debug(String.format("测试数：%s",1));
        $7DTD._Log.debug(KitData.Player.toTime(1747035958000L));
    }
}
