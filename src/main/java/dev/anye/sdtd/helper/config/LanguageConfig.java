        ...
        super(filePath, """
                {
                    ...
                    "usual.command.error.point.sub":"扣除积分失败",
                    ...
                    "apply_white.command.done":"{0}白名单添加完成",
                    ...
                    "buy_save_item_num.command.success":"已增加{0}个跟档物品数量，当前数量{1}",
                    ...
                    "check_save_item.command.target_items":"对方跟档物品:{0}",
                    ...
                    "find_white.command.success":"包含类似物品的白名单:{0}",
                    "receive_gift.command.error.args_number":"指令格式错误，正确格式：领取礼包 礼包名称",
                    "receive_gift.command.error.has":"您已领取过【{0}】礼包",
                    ...
                    "bind.command.error.not_found":"未找到玩家，请确认您的昵称（{0}）与游戏昵称是否一致，注意大小写，并且是否在线",
                    ...
                    "raffle.command.success":"花费{0}积分，抽奖结果：\\\\n{1}",
                    ...
                    "request_save_item.command.step.1":"请确认是否已将物品上的模组卸下，您可以跟档{0}个物品，如果确认无误请再次发送此指令。",
                    ...
                    "request_save_item.command.success":"物品记录完成，成功:{0} ，失败:{1}。",
                    "request_unban.command.error.has":"您已申请过解封，当前已有{0}个群员为您同意解封",
                    ...
                    "send_save_item.command.success":"成功提取{0}个物品",
                    ...
                    "request_info.command.success.plus":"玩家名称：{0}\\\\n登录时间：{1}\\\\n离线时间：{2}\\\\n等级：{3}\\\\n生命：{4}\\\\n技能点：{5}\\\\n状态：{6}",
                    "unban.command.success":"操作成功。",
                    "unban.command.error.net":"解封失败，请稍后再试"
                }
                """, new TypeToken<>(){});
    }
